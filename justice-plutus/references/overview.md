# Insight Claw Skill Overview

`insight-claw` is the local entry point for running the Insight Claw A-share
analysis pipeline on the current machine.
...
When configured, Insight Claw can enrich analysis with news, sentiment,
...
When configured, Insight Claw can improve chip-distribution analysis using:
