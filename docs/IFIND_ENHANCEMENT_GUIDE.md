...
- [auth.py](../src/ifind/auth.py)
  - 用 `refresh_token` 换取 `access_token`
  - 做进程内 token 缓存
- [client.py](../src/ifind/client.py)
  - 封装 iFinD HTTP 请求
- [mappers.py](../src/ifind/mappers.py)
  - 把原始返回映射为项目内统一结构
- [schemas.py](../src/ifind/schemas.py)
  - 定义财报包、估值包、预期包、质量摘要
- [service.py](../src/ifind/service.py)
...
- [tests/test_config_llm_and_stock_overrides.py](../tests/test_config_llm_and_stock_overrides.py)
- [tests/test_ifind_auth.py](../tests/test_ifind_auth.py)
- [tests/test_ifind_client.py](../tests/test_ifind_client.py)
- [tests/test_ifind_fetcher.py](../tests/test_ifind_fetcher.py)
- [tests/test_ifind_service.py](../tests/test_ifind_service.py)
- [tests/test_ifind_pipeline_integration.py](../tests/test_ifind_pipeline_integration.py)
- [tests/test_ifind_analyzer_prompt.py](../tests/test_ifind_analyzer_prompt.py)
