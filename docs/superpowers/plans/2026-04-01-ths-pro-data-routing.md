...
```bash
python3 -m pytest ./tests/test_config_llm_and_stock_overrides.py -k "ths_pro_data or ifind_flags" -v
```
...
```bash
git add ./src/config.py ./.env.example ./tests/test_config_llm_and_stock_overrides.py
...
```bash
python3 -m pytest ./tests/test_ifind_pipeline_integration.py -v
```
...
**Files:**
- Modify: `./src/ifind/client.py`
- Modify: `./src/ifind/service.py`
- Optional Modify: `./src/ifind/schemas.py`
...
```bash
python3 -m pytest ./tests/test_ifind_service.py -v
```
...
```bash
git add ./src/ifind/client.py ./src/ifind/service.py ./tests/test_ifind_service.py
...
**Files:**
- Create: `./data_provider/ifind_fetcher.py`
- Modify: `./data_provider/base.py`
- Test: `./tests/test_ifind_data_provider_routing.py`
...
```bash
python3 -m pytest ./tests/test_ifind_data_provider_routing.py -v
```
...
```bash
git add ./data_provider/ifind_fetcher.py ./data_provider/base.py ./tests/test_ifind_data_provider_routing.py
...
- Modify: `./src/core/pipeline.py`
- Modify: `./README.md`
- Modify: `./docs/FUNCTION_ARCHITECTURE.md`
- Modify: `./docs/IFIND_ENHANCEMENT_GUIDE.md`
...
python3 -m pytest \
  ...
  ./tests/test_ifind_data_provider_routing.py -v
```
...
```bash
git add ./src/core/pipeline.py ./README.md ./docs/FUNCTION_ARCHITECTURE.md ./docs/IFIND_ENHANCEMENT_GUIDE.md
...
- The untracked `./scripts/` workspace content is unrelated; do not revert or overwrite it.
