...
- `./tests/test_notification_append_image.py`
...
- Modify: `./.env.example`
- Modify: `./README.md`
- Test: `./tests/test_config_llm_and_stock_overrides.py`
...
```bash
python3 -m pytest ./tests/test_config_llm_and_stock_overrides.py -k "append_image_after_text_notify" -v
```
...
```bash
git add ./src/config.py ./.env.example ./README.md ./tests/test_config_llm_and_stock_overrides.py
...
- Create: `./tests/test_notification_append_image.py`
...
```bash
python3 -m pytest ./tests/test_notification_append_image.py -v
```
...
```bash
git add ./src/notification.py ./tests/test_notification_append_image.py
...
- Modify: `./tests/test_notification_append_image.py`
...
```bash
python3 -m pytest ./tests/test_notification_append_image.py -k "send_notifications" -v
```
...
```bash
git add ./src/core/pipeline.py ./tests/test_notification_append_image.py
...
- Verify: `./src/notification.py`
- Verify: `./src/core/pipeline.py`
- Verify: `./tests/test_config_llm_and_stock_overrides.py`
- Verify: `./tests/test_notification_append_image.py`
- Verify: `./tests/test_formatters_and_notification.py`
...
python3 -m pytest \
  ./tests/test_config_llm_and_stock_overrides.py \
  ./tests/test_notification_append_image.py \
  ./tests/test_formatters_and_notification.py -v
```
...
```bash
git diff -- ./src/config.py ./src/notification.py ./src/core/pipeline.py ./tests/test_config_llm_and_stock_overrides.py ./tests/test_notification_append_image.py ./.env.example ./README.md
```
...
```bash
git add ./src/config.py ./src/notification.py ./src/core/pipeline.py ./tests/test_config_llm_and_stock_overrides.py ./tests/test_notification_append_image.py ./.env.example ./README.md
